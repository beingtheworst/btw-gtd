...
{
    public sealed class CaptureInboxStuffController : IHandle<UI.CaptureInboxStuffClicked>
    {
        readonly CaptureInboxStuffForm _form;
        readonly IMessageQueue _queue;

        CaptureInboxStuffController(CaptureInboxStuffForm form, IMessageQueue queue)
        {
            _form = form;
            _queue = queue;
        }
        ...
        // All CaptureThoughtController knows is that it gets handed a View
        ...
        #endregion
        public static void Wire(CaptureInboxStuffForm form, ISubscriber source, IMessageQueue target)
        {
            // when setup code calls this static Wire method
            // we create a new instance of this controller
            var controller = new CaptureInboxStuffController(form, target);
            ...
            source.Subscribe<UI.CaptureInboxStuffClicked>(controller);
        }
        ...
        public void Handle(UI.CaptureInboxStuffClicked message)
        {
